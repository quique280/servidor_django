...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\2\2\21,\3\2\2\2\23.\3\2\2\2\25\61\3\2\2\2\27\65\3\2")
        ...
        buf.write("\2\2./\7/\2\2/\60\7@\2\2\60\24\3\2\2\2\61\62\7>\2\2\62")
...
class WangLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "COMMA", "DOT", "LEADSTO", "NOT", "AND", "OR", "IMPLIES", "BICONDITIONAL", 
            "ID", "WS", "ErrorChar" ]

    ruleNames = [ "T__0", "T__1", "COMMA", "DOT", "LEADSTO", "NOT", "AND", 
                  "OR", "IMPLIES", "BICONDITIONAL", "ID", "WS", "ErrorChar" ]
